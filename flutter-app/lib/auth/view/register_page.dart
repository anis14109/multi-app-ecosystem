...
///
/// Displays name, email, password, and confirmation fields inside the
/// modern auth layout used across the app. On success, the AuthBloc
/// transitions to `AuthSetupRequired`. Validation errors are shown
